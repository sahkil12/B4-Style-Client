...
import { heroContainerVariants, heroChildVariants } from "../../../utils/CardAnimation";
          ...
          >
               ...
               <div className="relative z-10 h-full mx-auto px-4 pt-14 flex items-center">
                    <motion.div
                         ...
                         {/* stats */}
                         <motion.div variants={heroChildVariants} className="flex gap-8 sm:gap-10 pt-8 sm:pt-10">
