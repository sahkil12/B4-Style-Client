...
const About = () => {
     return (
          <>
               <SEO
                    title="About"
                    description="Learn more about B4 Style, our mission, values and commitment to providing high quality clothing and fashion products in Bangladesh."
                    keywords="about B4 Style, fashion brand bangladesh, clothing store"
               />
