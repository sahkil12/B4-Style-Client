...
const Profile = () => {
     ...
     return (
          <>
               <SEO
                    title="Profile"
                    description="Manage your personal information, orders, and account settings in your B4 Style profile."
                    keywords="user profile, account settings, B4 Style account"
               />
               ...
               <div className="text-accent flex items-center justify-center px-4 mt-20 py-20">
                    ...
                    >
                         ...
                         <div className="space-y-3">
                              {menuItems?.slice(slices, 4).map((item) => (
                                   <div
                                        onClick={() => {
                                             if (item?.logout) {
                                                  item.logout();
